                                ...
                                <div class="product-item-holder size-big single-product-gallery small-gallery">
                                    ...
                                    <div id="owl-single-product">
                                        ...
                                        @foreach ($product->galleryImages as $gallery_image)
                                            <div class="single-product-gallery-item" id="slide{{ $gallery_image->id }}">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                    href="{{ asset('uploads/backend/gallery_images/' . $gallery_image->gallery_image) }}">
                                                    <img class="img-responsive" alt=""
                                                        src="{{ asset('uploads/backend/gallery_images/' . $gallery_image->gallery_image) }}"
                                                        data-echo="{{ asset('uploads/backend/gallery_images/' . $gallery_image->gallery_image) }}" />
                                                </a>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="single-product-gallery-thumbs gallery-thumbs">
                                        ...
                                        <div id="owl-single-product-thumbnails">
                                            ...
                                            @foreach ($product->galleryImages as $gallery_image)
                                                <div class="item">
                                                    <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                        data-slide="1" href="#slide{{ $gallery_image->id }}">
                                                        <img class="img-responsive" width="85" alt=""
                                                            src="{{ asset('uploads/backend/gallery_images/' . $gallery_image->gallery_image) }}"
                                                            data-echo="{{ asset('uploads/backend/gallery_images/' . $gallery_image->gallery_image) }}" />
                                                    </a>
